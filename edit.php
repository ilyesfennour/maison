        ...
        foreach ($show as $result) {
            ...
            <div class="con">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" value="'.$result['disc'].'" placeholder="Description" name="des" class="in"><br>
                    ...
                    <input type="text" value="'.$result['adress'].'" placeholder="Address" name="adress" class="in" required><br>
                    <input type="text" value="'.$result['fonne'].'" placeholder="Phone number" name="f_num" class="in" required><br>
                    ...
                    if ($result['prix'] == '0') {echo' value="" ';} echo' placeholder="price" name="prix" class="in"><br>
                    <button name="cadd" class="btn">Modify</button>
                </form>
