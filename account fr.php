        ...
        <?php
            echo'<div class="con">
                <form action="" method="POST">
                    <span class="text">Prénom:</span><input type="text" placeholder="'.$_SESSION['user']->f_name.'" class="name" name="fname"><br>
                    <span class="text">Nom:</span><input type="text" placeholder="'.$_SESSION['user']->l_name.'" class="name" name="lname"><br>
                    <span class="text">Mot de passe:</span><input type="password" placeholder="'.$_SESSION['user']->password.'" class="name" name="pass"><br>
                    <span class="text">Confirmez le mot de passe:</span><input type="password" placeholder="'.$_SESSION['user']->password.'" class="name" name="cpass"><br>
